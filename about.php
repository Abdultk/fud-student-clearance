...
<header id="main-header">
    <div class="container">
        ...
        <h1 style="font-size:40px"> F.U.D Student Clearance Portal</h1>
    </div>
</header>
    ...
    <section id="showcase">
        <div class="container">
            <p> This Portal was developed using PHP and MySQL, Ajax, JQuery & Bootstrap
                to manage clearance process of all Final Year Students in Federal University Dutse
            </p>
        </div>
    </section>
</div>
...
<div class="container">
    <footer id="main-footer">
        <p> Copyright &copy; 2022 F.U.D Clearance</p>
    </footer>
</div>
<style>
    body{
