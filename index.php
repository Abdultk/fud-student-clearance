...
<head>
    ...
    <title>  Federal University Duste Student Clearance Portal | Welcome </title>
</head>
<header id="main-header">
    <div class="container">
        <img src="images/ktu_logo.png">
        <h1 style="font-size:40px"> Federal University Duste Clearance Portal</h1>
    </div>
</header>
...
<div class="container">
    <footer id="main-footer">
        <p> Copyright &copy; 2022  Federal University Duste Clearance</p>
    </footer>
</div>
<style>
    body{
